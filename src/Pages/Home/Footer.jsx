  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img className="nav--logo" src="./img/logo.png" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/marjhonie.dev"
            ...
            <li>
              <a
                href="https://www.instagram.com/marjhonie.dev"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.tiktok.com/@marjhonie.dev"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.twitter.com/marjhonie_dev"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/marjhonie-siasol/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        {/* <p className="footer--content">Website by Marjhonie</p> */}
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
